...
#                 contents = f"without bolding the text , Talk to me in Gen Z slang and gossip about celebrities: {user_message} and also ask me a question based on my input and also make the conversation short"
#             )
